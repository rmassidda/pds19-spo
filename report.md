...
The function presents a unique global minimum in the interval $x,y \in \left[ 0, 4 \right]$ and is computational time cost can be arbitrarily adjusted by setting the precision of the Riemann sum used to approximate it.
